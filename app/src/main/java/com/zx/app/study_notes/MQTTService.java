...
public class MQTTService extends Service {
    ...
    public String HOST = "ws://34.92.58.208:8081/ws";//服务器地址（协议+地址+端口号）
...
////            ? Build.getSerial() : Build.SERIAL;//客户端ID，一般以客户端唯一标识符表示，这里用设备序列号表示
    ...
    // 特许权限才能访问设备的不可重置标识符（包含 IMEI 和序列号）。而这个权限只可能赋予给预装在系统分区的应用
    ...
    private IMqttActionListener iMqttActionListener = new IMqttActionListener() {
        ...
        public void onSuccess(IMqttToken arg0) {
            ...
            try {
                ...
                mqttAndroidClient.subscribe("/member/balance/3067127154209153", 0);
                //比赛相关
                mqttAndroidClient.subscribe("/match/#", 0);
                //盘口相关
                mqttAndroidClient.subscribe("/market/#", 0);
            } catch (MqttException e) {
                e.printStackTrace();
            }
        }
